...
import 'package:flutter_cbt_tpa_app/material.dart'; // Ganti sesuai lokasi warna Anda
            ...
            child: dummyTransactions.isEmpty
                ? Column(
                    ...
                    children: [
                      ...
                      const Text("Saat ini tidak ada transaksi. Mulai transaksi sekarang."),
                    ],
                  )
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          title: Text(tx['invoice']!, style: const TextStyle(fontWeight: FontWeight.bold)),
                          subtitle: Text(tx['tanggal']!),
                          trailing: Column(
                            crossAxisAlignment: CrossAxisAlignment.end,
                            children: [
                              Text(tx['jumlah']!, style: const TextStyle(fontWeight: FontWeight.bold)),
                              const SizedBox(height: 4),
                              Text(
                                tx['status']!,
                                style: TextStyle(
